...
cp -a /system/etc/phronesis/keyboard/250/system/lib/* /system/lib/
cp -r /system/etc/phronesis/keyboard/250/system/app/* /system/app/


chmod 755 /system/app/SamsungIMEv2_5
